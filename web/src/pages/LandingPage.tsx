  ...
  return (
    <LandingPageView
      ...
      texts={{
        ...
        landing_compare_status_label: t("landing_compare_status_label"),
        landing_compare_status_jobwatch: t("landing_compare_status_jobwatch"),
        landing_compare_status_mlflow: t("landing_compare_status_mlflow"),
        landing_compare_status_tensorboard: t("landing_compare_status_tensorboard"),
        ...
        landing_compare_infra_label: t("landing_compare_infra_label"),
        landing_compare_infra_jobwatch: t("landing_compare_infra_jobwatch"),
        landing_compare_infra_mlflow: t("landing_compare_infra_mlflow"),
        landing_compare_infra_tensorboard: t("landing_compare_infra_tensorboard"),
        ...
        landing_footer_blurb: t("landing_footer_blurb"),
        landing_footer_product: t("landing_footer_product"),
        landing_footer_company: t("landing_footer_company"),
      }}
    />
  );
}
