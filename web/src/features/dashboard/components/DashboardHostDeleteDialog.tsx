// Responsibility: Render host delete confirmation dialog.
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
type DashboardHostDeleteDialogProps = {
...
export default function DashboardHostDeleteDialog({
  deleteConfirmTitle,
  ...
  onCancelDelete,
  onConfirmDelete,
}: DashboardHostDeleteDialogProps) {
  return (
    <AlertDialog open={Boolean(pendingDeleteHostId)}>
