...
type DashboardWorkspaceDeleteDialogProps = {
...
export default function DashboardWorkspaceDeleteDialog({
  deleteConfirmTitle,
  ...
  onCancelDelete,
  onConfirmDelete,
}: DashboardWorkspaceDeleteDialogProps) {
  return (
    <AlertDialog open={Boolean(pendingDeleteWorkspaceId)}>
